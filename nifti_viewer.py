...
ax3.hlines(tmY, 0, lX, colors='green', linestyles='dotted', linewidth=.5)
ax3.vlines(tmX, 0, lY, colors='green', linestyles='dotted', linewidth=.5)
...
ax2.hlines(tmZ, 0, lY, colors='green', linestyles='dotted', linewidth=.5)
ax2.vlines(tmY, 0, lZ, colors='green', linestyles='dotted', linewidth=.5)
...
ax1.hlines(tmZ, 0, lX, colors='green', linestyles='dotted', linewidth=.5)
ax1.vlines(tmX, 0, lZ, colors='green', linestyles='dotted', linewidth=.5)
...
# Display
plt.title('Copyright @ S. M. Kamrul Hasan',fontsize=6)
plt.show()
